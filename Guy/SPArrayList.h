...
typedef struct sp_array_list_t {
	int* elements; //each element, within 'elements', here is a 4-int path, corresponding
						//to one move in a chess game (<x,y> -> <w,z>; where x,y,z,w are ints)
	int actualSize;
	int maxSize;
} SPArrayList;
 ...
 * @param src   - the source array list
 * @param elem  - the new element (4-int array) to be inserted
...
/**
 * Removes an element (4-int array) from a specified index. The elements residing after the
 * specified index will be shifted to keep the list continuous. If the
...
/**
 * Removes an element (4-int array) from a the beginning of the list.
...
/**
 * Removes an element (4-int array) from a the end of the list.
 * The elements will be shifted to keep the list continuous. If the
 * array list is empty then an error message is returned and the source list
 * is not affected
 * @param src   - The source array list
...
/**
 * Returns the element (4-int array) at the specified index. The function is called
 ...
 * Otherwise, the element (4-int array) at the specified index is returned.
 */
int *spArrayListGetAt(SPArrayList* src, int index);

/**
 * Returns the element (4-int array) at the beginning of the list. The function is called
 * with the assertion that all arguments are valid. If any of the arguments is
 * invalid then an undefined value is returned.
 * @param src - the source array list
 * @return
 * Undefined value if either src == NULL or the list is empty
 * Otherwise, the element (4-int array) at the beginning of the list is returned.
 */
int *spArrayListGetFirst(SPArrayList* src);

/**
 * Returns the element (4-int array) at the end of the list. The function is called
 * with the assertion that all arguments are valid. If any of the arguments is
 * invalid then an undefined value is returned.
 * @param src - the source array list
 * @return
 * Undefined value if either src == NULL or the list is empty
 * Otherwise, the element (4-int array) at the end of the list is returned.
 */
...
/**
 * Returns the number of elements (4-int arrays) in the list. The function is called
 * with the assertion that all arguments are valid. If any of the arguments is
 * invalid then an undefined value is returned.
 * @param src - the source array list
 * @return
...
/**
 * Returns true if the list is full, that is the number of elements (4-int arrays) in the list
...
/**
 * Returns true if the list is empty, that is the number of elements (4-int arrays) in the list
 * equals to zero.
 * @param src - the source array list
 * @return
